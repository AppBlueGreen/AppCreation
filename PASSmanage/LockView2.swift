...
//  PASSmanage
//
//  Created by aoi suzuki on 2024/09/21.
//

import SwiftUI

struct LockView2: View {
        ...
        VStack {
            ...
            LazyVGrid(columns: Array(repeating: GridItem(.flexible()), count: 3), spacing: 5 ) {
                ...
                ForEach(1...9, id: \.self) { value in
                    ...
                    PasswordButton2(value: "\(value)", password3: $password3, key: $key, wrongPass: $wrongPassword,unLocked: $unLocked)
                }
                ...
                PasswordButton2(value: "0", password3: $password3, key: $key, wrongPass: $wrongPassword,unLocked: $unLocked)
                
                PasswordButton2(value: "delete.fill", password3: $password3, key: $key, wrongPass: $wrongPassword,unLocked: $unLocked)
